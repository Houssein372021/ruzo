            ...
            {filteredReviews.map((review) => (
              <tr key={review.id}>
                <td>
                  ...
                  <p className="mt-1 text-xs text-[#444444]">{review.orderNumber}</p>
                </td>
                <td>
                  <p>{review.customerName}</p>
                  <p className="mt-1 text-xs text-[#444444]">{review.customerEmail}</p>
                </td>
                <td>
                ...
                <td className="min-w-72">
                  ...
                  <p className="mt-1 text-sm leading-6 text-[#555555]">{review.body}</p>
                </td>
                <td>
