  ...
  return (
    <>
      <Seo
        ...
        path="/about"
      />
      <section className="grid min-h-[72vh] border-b border-[#080808]/10 lg:grid-cols-2">
        ...
        <div className="flex items-center px-6 py-16 sm:px-10 lg:px-16">
          <div className="max-w-xl">
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#6B0F1A]">{t("aboutEyebrow")}</p>
            <h1 className="mt-4 text-4xl font-semibold leading-tight sm:text-5xl">{t("brandStory")}</h1>
            <p className="mt-6 text-sm leading-8 text-[#080808]/68">
              {t("aboutCopy")}
            </p>
          </div>
        </div>
